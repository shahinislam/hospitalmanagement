...
<?php $__env->startSection('content'); ?>
      ...
      <ul class="tabs">
               ...
               <tbody> 
                 <?php echo $__env->make('info-box', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                  ...
                  <tr>
                   ...
                   <td><a href="<?php echo e(route('doctor.patient.delete',['patient_id'=>$patient->id,'patient_email'=>$patient->email])); ?>" class="danger">Delete</a></td>
                   </tr>
        ...
        <li>
          ...
          <div class="tab-content">
             <form action="<?php echo e(route('doctor.patient.insert')); ?>" method="post">
