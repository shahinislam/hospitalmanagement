...
<body>
    <?php echo $__env->make('includes_pharmacist.pharmacist-header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php echo $__env->make('includes_pharmacist.pharmacist-navigation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
