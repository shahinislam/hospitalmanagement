...
<body>
    <?php echo $__env->make('includes_laboratorist.laboratorist-header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php echo $__env->make('includes_laboratorist.laboratorist-navigation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
