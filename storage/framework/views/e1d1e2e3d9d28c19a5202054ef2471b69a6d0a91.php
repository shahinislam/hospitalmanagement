...
<body>
    <?php echo $__env->make('includes_doctor.doctor-header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php echo $__env->make('includes_doctor.doctor-navigation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
