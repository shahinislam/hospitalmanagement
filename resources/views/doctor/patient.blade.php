...
@section('content')
      ...
      <ul class="tabs">
               ...
               <tbody> 
                 @include('info-box')
                  ...
                  <tr>
                   ...
                   <td>{{ $patient->blood }}</td>
                   <td>{{ $patient->birth }}</td>
                   <td><a href="{{ route('doctor.patient.delete',['patient_id'=>$patient->id,'patient_email'=>$patient->email]) }}" class="danger">Delete</a></td>
                   </tr>
                  @endforeach
               </tbody>
            </table>
        ...
        <li>
          ...
          <div class="tab-content">
             <form action="{{ route('doctor.patient.insert') }}" method="post">
